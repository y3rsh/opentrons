...
@pytest.fixture
async def set_temperature_subject(loop, usb_port: USBPort, simulator_set_plate_spy: SimulatingDriver) -> modules.Thermocycler:
...
async def test_cycle_temperature(
    ...
    """It should send a series of set_plate_temperature commands from a configuration."""
