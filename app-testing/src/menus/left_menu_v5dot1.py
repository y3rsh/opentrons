...
class LeftMenu:
    ...
    gear: Element = Element((By.XPATH, '//a[contains(@href,"#/app-settings/general")]'), "Left menu bottom gear to go to App Settings")
    ...
    def get_labware_button(self) -> Optional[WebElement]:
